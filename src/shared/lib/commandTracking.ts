...
import {
  ...
  getActiveMissions,
  getMissions,
} from "@features/missions/model";
import { markNeoCorpHacked, isNeoCorpHacked } from "@features/virus/model";
import { trackFileRead, trackHack } from "@shared/lib/progress";
...
export const ensureTrojanDeactivationFile = (): void => {
  try {
    const fs = getFileSystem();
    const secretsDir = "/home/user/secrets";
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━`;
    ...
    console.warn("Failed to ensure trojan deactivation file", e);
  }
};

export const ensureLainDeactivationFile = (): void => {
  try {
    const fs = getFileSystem();
    const secretsDir = "/home/user/secrets";
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━`;
    ...
    console.warn("Failed to ensure lain deactivation file", e);
  }
};
...
export const trackFileReadCommand = async (
  ...
  const { markContactsRead } = await import("@shared/lib/contacts");
  ...
  if (fs[filePath] && fs[filePath].type === "file") {
    ...
    if (filePath.includes("contacts.txt") || filePath.endsWith("/contacts.txt")) {
      markContactsRead();
    }

    if ((filePath.includes("system_access") || filePath.includes("log")) && Math.random() < 0.3) {
...
export const getMissionNotification = (missionId: string | null): string | null => {
