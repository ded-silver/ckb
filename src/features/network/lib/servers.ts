...
export const SERVERS: ServerInfo[] = [
  {
    ...
    password: "ADMIN123",
    difficulty: "easy",
    hintFiles: ["/home/user/documents/notes.txt", "/home/user/logs/system_access.log"],
  ...
  },
  {
    ...
    difficulty: "medium",
    hintFiles: ["/home/user/documents/notes.txt", "/home/user/secrets/network_map.txt"],
  ...
  },
  {
    ...
    password: "MATRIX2024",
    difficulty: "hard",
    hintFiles: ["/home/user/documents/contacts.txt", "/home/user/logs/hack_attempts.log"],
...
export const markServerAsCracked = (ip: string): void => {
  try {
    ...
    if (!servers.includes(ip)) {
      servers.push(ip);
      localStorage.setItem("cyberpunk_cracked_servers", JSON.stringify(servers));
    }
  } catch (e) {
