      ...
      webcam: {
        ...
        contents: {
          "webcam.exe": {
            type: "file",
            content:
              "ASCII WEBCAM APPLICATION\n━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n\n[2077-03-20] ASCII Webcam v1.0\n[2077-03-20] Author: Cyberpunk Terminal Team\n[2077-03-20] Classification: SURVEILLANCE INTERFACE\n\nThis is the ASCII Webcam executable.\nA terminal-based camera interface that converts video feed\ninto ASCII art in real-time.\n\nTo run:\n  open webcam.exe\n  or\n  ./webcam/webcam.exe\n  or\n  webcam\n  or\n  ascii-cam\n\nFeatures:\n  - Real-time ASCII art conversion\n  - Multiple rendering styles (default, dense, simple, blocks)\n  - Adjustable resolution\n  - Brightness inversion\n  - Terminal-based interface\n  - FPS monitoring\n\n━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\nSECURITY WARNING: CAMERA ACCESS REQUIRED\n━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n\nThis application requires camera access to function.\nBy granting permission, you allow the system to monitor\nyour visual environment through the connected camera device.\n\nRemember: In the Wired, nothing is truly private.\nYour visual data is processed locally, but the Wired\nhas ways of seeing what you see.\n\nSome users report seeing things in the ASCII output\nthat weren't there in reality. Glitches in perception?\nOr something else watching through the camera?\n\n━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\nKNOWN ISSUES:\n━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n\n- High resolution settings may cause performance degradation\n- Camera disconnection may trigger error states\n- Some users report seeing ASCII patterns that form messages\n- Neural interface interference may corrupt ASCII output\n- Camera feed may occasionally show frames from alternate timelines\n\n━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\nUSAGE:\n━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n\nCommands:\n  start / on          - Begin camera streaming\n  stop / off          - Stop camera streaming\n  resolution <w> <h>  - Set ASCII output resolution\n  resolution auto     - Auto-detect optimal resolution\n  style <name>        - Change ASCII character set\n  invert              - Toggle brightness inversion\n  stats / status      - Display current statistics\n  theme <name>        - Change visual theme\n  size <w> <h>        - Resize application window\n  help                - Show command reference\n  close / exit        - Close application\n\nExample:\n  start\n  resolution 80 40\n  style dense\n  invert\n  stats\n\n━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\nPROTOCOL: Wired Camera Interface v1.0\nSTATUS: READY\nENCRYPTION: LOCAL PROCESSING ONLY\n━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━",
          },
        },
      },
      games: {
  ...
  "/home/user/webcam": {
    ...
    contents: {
      "webcam.exe": {
        type: "file",
        content:
          "ASCII WEBCAM APPLICATION\n━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n\n[2077-03-20] ASCII Webcam v1.0\n[2077-03-20] Author: Cyberpunk Terminal Team\n[2077-03-20] Classification: SURVEILLANCE INTERFACE\n\nThis is the ASCII Webcam executable.\nA terminal-based camera interface that converts video feed\ninto ASCII art in real-time.\n\nTo run:\n  open webcam.exe\n  or\n  ./webcam/webcam.exe\n  or\n  webcam\n  or\n  ascii-cam\n\nFeatures:\n  - Real-time ASCII art conversion\n  - Multiple rendering styles (default, dense, simple, blocks)\n  - Monochrome and colored modes\n  - Adjustable resolution\n  - Terminal-based interface\n  - FPS monitoring\n\n━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\nSECURITY WARNING: CAMERA ACCESS REQUIRED\n━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n\nThis application requires camera access to function.\nBy granting permission, you allow the system to monitor\nyour visual environment through the connected camera device.\n\nRemember: In the Wired, nothing is truly private.\nYour visual data is processed locally, but the Wired\nhas ways of seeing what you see.\n\nSome users report seeing things in the ASCII output\nthat weren't there in reality. Glitches in perception?\nOr something else watching through the camera?\n\n━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\nKNOWN ISSUES:\n━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n\n- High resolution settings may cause performance degradation\n- Colored mode requires ANSI terminal support\n- Camera disconnection may trigger error states\n- Some users report seeing ASCII patterns that form messages\n- Neural interface interference may corrupt ASCII output\n- Camera feed may occasionally show frames from alternate timelines\n\n━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\nUSAGE:\n━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n\nCommands:\n  start / on          - Begin camera streaming\n  stop / off          - Stop camera streaming\n  resolution <w> <h>  - Set ASCII output resolution\n  resolution auto     - Auto-detect optimal resolution\n  style <name>        - Change ASCII character set\n  mode <mono|color>   - Switch between monochrome/colored\n  invert              - Toggle brightness inversion\n  stats / status      - Display current statistics\n  theme <name>        - Change visual theme\n  size <w> <h>        - Resize application window\n  help                - Show command reference\n  close / exit        - Close application\n\nExample:\n  start\n  resolution 80 40\n  style dense\n  mode colored\n  stats\n\n━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\nPROTOCOL: Wired Camera Interface v1.0\nSTATUS: READY\nENCRYPTION: LOCAL PROCESSING ONLY\n━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━",
      },
    },
  },
  "/home/user/webcam/webcam.exe": {
    type: "file",
    content:
      "ASCII WEBCAM APPLICATION\n━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n\n[2077-03-20] ASCII Webcam v1.0\n[2077-03-20] Author: Cyberpunk Terminal Team\n[2077-03-20] Classification: SURVEILLANCE INTERFACE\n\nThis is the ASCII Webcam executable.\nA terminal-based camera interface that converts video feed\ninto ASCII art in real-time.\n\nTo run:\n  open webcam.exe\n  or\n  ./webcam/webcam.exe\n  or\n  webcam\n  or\n  ascii-cam\n\nFeatures:\n  - Real-time ASCII art conversion\n  - Multiple rendering styles (default, dense, simple, blocks)\n  - Adjustable resolution\n  - Brightness inversion\n  - Terminal-based interface\n  - FPS monitoring\n\n━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\nSECURITY WARNING: CAMERA ACCESS REQUIRED\n━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n\nThis application requires camera access to function.\nBy granting permission, you allow the system to monitor\nyour visual environment through the connected camera device.\n\nRemember: In the Wired, nothing is truly private.\nYour visual data is processed locally, but the Wired\nhas ways of seeing what you see.\n\nSome users report seeing things in the ASCII output\nthat weren't there in reality. Glitches in perception?\nOr something else watching through the camera?\n\n━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\nKNOWN ISSUES:\n━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n\n- High resolution settings may cause performance degradation\n- Camera disconnection may trigger error states\n- Some users report seeing ASCII patterns that form messages\n- Neural interface interference may corrupt ASCII output\n- Camera feed may occasionally show frames from alternate timelines\n\n━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\nUSAGE:\n━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\n\nCommands:\n  start / on          - Begin camera streaming\n  stop / off          - Stop camera streaming\n  resolution <w> <h>  - Set ASCII output resolution\n  resolution auto     - Auto-detect optimal resolution\n  style <name>        - Change ASCII character set\n  invert              - Toggle brightness inversion\n  stats / status      - Display current statistics\n  theme <name>        - Change visual theme\n  size <w> <h>        - Resize application window\n  help                - Show command reference\n  close / exit        - Close application\n\nExample:\n  start\n  resolution 80 40\n  style dense\n  invert\n  stats\n\n━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\nPROTOCOL: Wired Camera Interface v1.0\nSTATUS: READY\nENCRYPTION: LOCAL PROCESSING ONLY\n━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━",
  },
